...
if (!pageRoot) { /* noop */ }
  ...
  function preprocessMath(text) {
    ...
    // Safely catch "naked" block math generated by AI (lines lacking $$ but clearly math)
    // Examines cases like \begin{...}, \sum, \int, \mathcal, or equations like Lu = ...
    text = text.replace(/^(?!\s*\$)(?:\s*)(?:Lu\s*=|\\begin\{[a-z*]+\}|\\sum|\\int|\\mathcal|\\lim|\w+\s*=\s*(?:\\sum|\\int|\\frac|-?[\w\d]*\s*[\+\-]\s*))([\s\S]*?)(?:\n\n|$)/gm, (match) => {
      // If it already contains $$, skip wrapping
