...
<head>
    ...
    <title>{{ config('app.name', 'JriGPT') }}</title>
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium text-2xl">Selamat Datang di JriGPT</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Platform Rekayasa Kecerdasan Buatan
                    Terpadu.<br>Silakan menelusuri menu berikut.</p>
