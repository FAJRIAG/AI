...
<body
  ...
  <div class="hidden lg:flex lg:w-[55%] xl:w-[60%] flex-col justify-between p-8 lg:p-12 xl:p-16 relative overflow-hidden bg-[#050505] border-r border-white/5">
    ...
    <div class="relative z-10 max-w-2xl mt-12 mb-10">
      <h1 class="text-4xl xl:text-5xl font-semibold text-white leading-[1.15] tracking-tight mb-4">
        The Autonomous <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400">Agentic AI</span> Framework.
      </h1>
      <p class="text-zinc-400 text-base xl:text-lg leading-relaxed font-light">
        Selamat datang di ekosistem asisten cerdas masa depan. Dilengkapi dengan infrastruktur ReAct, memori abadi, dan integrasi studio desain secara real-time.
      </p>
    </div>
        ...
        <div class="group relative bg-[#0c0c0e]/80 backdrop-blur-xl rounded-2xl border border-white/5 p-6 hover:bg-[#111115] hover:border-emerald-500/30 transition-all duration-500 overflow-hidden cursor-default shadow-lg">
            ...
            <div class="relative z-10 flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-zinc-500 group-hover:text-zinc-400 transition-colors leading-relaxed">Arsitektur ReAct cerdas. Mampu menembus proteksi situs modern, menyusun rencana, dan meriset informasi secara mendalam dan otonom.</p>
                </div>
            </div>
        </div>
        ...
        <div class="group relative bg-[#0c0c0e]/80 backdrop-blur-xl rounded-2xl border border-white/5 p-6 hover:bg-[#111115] hover:border-emerald-500/30 transition-all duration-500 overflow-hidden cursor-default shadow-lg">
            ...
            <div class="relative z-10 flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-zinc-500 group-hover:text-zinc-400 transition-colors leading-relaxed">Antarmuka kelas profesional. Render kode HTML/CSS, visualisasi data, dan diagram Mermaid secara instan dalam panel *live preview* interaktif.</p>
                </div>
            </div>
        </div>
        ...
        <div class="group relative bg-[#0c0c0e]/80 backdrop-blur-xl rounded-2xl border border-white/5 p-6 hover:bg-[#111115] hover:border-emerald-500/30 transition-all duration-500 overflow-hidden cursor-default shadow-lg">
            ...
            <div class="relative z-10 flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-zinc-500 group-hover:text-zinc-400 transition-colors leading-relaxed">Memori sistem tiada batas. JriGPT memahami puluhan kode, PDF, dan sejarah komunikasi proyek Anda dengan teknologi *Vector Embeddings*.</p>
                </div>
            </div>
        </div>
        ...
        <div class="group relative bg-[#0c0c0e]/80 backdrop-blur-xl rounded-2xl border border-white/5 p-6 hover:bg-[#111115] hover:border-emerald-500/30 transition-all duration-500 overflow-hidden cursor-default shadow-lg">
            ...
            <div class="relative z-10 flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-zinc-500 group-hover:text-zinc-400 transition-colors leading-relaxed">Kecerdasan emosional real-time. UI dan gaya bahasa AI akan secara otomatis beradaptasi dengan *mood* dan urgensi percakapan Anda.</p>
                </div>
            </div>
        </div>
  ...
  <main class="flex-1 flex flex-col justify-center items-center px-4 sm:px-6 py-8 relative bg-[#050505] lg:bg-[#0a0a0c] w-full min-h-screen lg:min-h-0 lg:h-screen lg:overflow-y-auto">
    <!-- Mobile header -->
    <div class="lg:hidden flex items-center justify-center gap-3 mb-12 w-full max-w-sm relative z-10">
    ...
    <div class="w-full max-w-md bg-[#0c0c0e] lg:bg-transparent p-8 sm:p-10 border border-white/5 lg:border-none shadow-2xl lg:shadow-none rounded-3xl lg:rounded-none relative z-10">
      ...
      <div class="mb-10 text-center lg:text-left">
        <h2 class="text-3xl font-semibold text-white tracking-tight mb-3">Login Portal</h2>
        <p class="text-sm text-zinc-400 font-light">Masukkan kredensial Enterprise Anda untuk mengakses ekosistem JriGPT.</p>
      </div>
      ...
      <form method="POST" action="{{ route('login') }}" class="space-y-6">
        ...
        <div class="space-y-2 group/input">
          <div class="flex items-center justify-between">
            <label for="password" class="block text-sm font-medium text-zinc-400 transition-colors group-focus-within/input:text-emerald-400">Security Key</label>
          </div>
          <div class="relative">
        ...
        <div class="pt-1 flex items-center justify-between text-sm">
          <label class="inline-flex items-center gap-2.5 cursor-pointer group/check">
            <div class="relative flex items-center justify-center">
              <input type="checkbox" name="remember"
                class="peer appearance-none w-4 h-4 rounded border border-zinc-700 bg-zinc-900 checked:bg-emerald-500 checked:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:ring-offset-1 focus:ring-offset-[#0a0a0c] transition-colors cursor-pointer">
              <svg class="absolute w-2.5 h-2.5 text-black pointer-events-none opacity-0 peer-checked:opacity-100 transition-opacity"
                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3">
                <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"></path>
              </svg>
            </div>
            <span class="text-zinc-400 group-hover/check:text-zinc-200 transition-colors font-medium">Ingat Sesi Saya</span>
          </label>

          @if (Route::has('password.request'))
            <a href="{{ route('password.request') }}" class="text-zinc-500 hover:text-emerald-400 transition-colors font-medium">Pemulihan Akses?</a>
          @endif
        </div>
      ...
      {{-- Secondary actions --}}
      <div class="mt-10 flex flex-col items-center justify-center gap-4 text-sm w-full border-t border-white/5 pt-8">
        @if (Route::has('register'))
          <p class="text-zinc-500 text-center">
            Membutuhkan akses platform?
            <a href="{{ route('register') }}" class="text-zinc-300 hover:text-emerald-400 font-medium transition-colors ml-1">Ajukan Akses VIP</a>
          </p>
        @endif

        <a href="{{ url('/') }}" class="inline-flex items-center gap-1.5 text-zinc-600 hover:text-zinc-300 transition-colors mt-2">
          <svg class="size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M10 19l-7-7 7-7M3 12h18"></path>
          </svg>
          Kembali ke Public Preview
        </a>
      </div>
