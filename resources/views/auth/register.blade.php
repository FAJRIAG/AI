  ...
  <div class="min-h-screen grid place-items-center px-4">
    <div class="w-full max-w-lg">
      <div class="text-center mb-6">
        <div
          class="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 text-xs text-gray-300">
        ...
        <p class="mt-1 text-sm text-gray-400">Kami sedang menyiapkan versi berikutnya dari layanan ini. Terima kasih
      ...
      <div class="rounded-2xl border border-white/10 bg-[#0c1117] p-6">
        <div class="space-y-4 text-sm text-gray-300">
          ...
          <p class="text-gray-400">Sementara itu, Anda masih bisa mencoba JriGPT publik di beranda.</p>
        </div>
      ...
      <p class="mt-4 text-center text-xs text-gray-500">
        Perlu bantuan? <a href="mailto:jridev2@gmail.com"
          class="underline decoration-dotted hover:text-gray-300">Hubungi admin</a>.
      </p>
    </div>
  </div>
</body>
